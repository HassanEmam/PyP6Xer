...
def safe_atoi(val: str | None) -> int:
    """Convert string to integer, handling null/empty values and converting floats to int"""
    if val is None:
        return 0
    val = val.strip().lower()
    if val in ("", "null", "none"):
...
class TaskPred:
    ...
    def __init__(self, params):
        ...
        self.lag_hr_cnt = (
            safe_atoi(params.get("lag_hr_cnt").strip())
